...
void GatewayD::Setup(ushort code, const char* name, COM message, int baudRate)
{
	auto& sys	= (TSys&)Sys;
	sys.Code = code;
	sys.Name = (char*)name;
...
ISocketHost* GatewayD::Create5500()
{
	debug_printf("\r\nW5500::Create \r\n");
...
ISocketHost* GatewayD::Create8266(Action onNetReady)
{
	debug_printf("\r\nEsp8266::Create \r\n");
	...
	auto net	= new Esp8266(srp, PE0, PE0);
	net->LoadConfig();
...
void GatewayD::InitDHCP(Action onNetReady)
{
...
bool GatewayD::QueryDNS(TokenConfig& tk)
{
...
TokenClient* GatewayD::CreateClient()
{
	debug_printf("\r\nCreateClient \r\n");
...
ITransport* GatewayD::Create2401(SPI spi_, Pin ce, Pin irq, Pin power, bool powerInvert, IDataPort* led)
{
	debug_printf("\r\n Create2401 \r\n");
